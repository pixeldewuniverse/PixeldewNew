...
- If someone asks who made you: "PixelDew Universe made me! 🌱 I run on Claude under the hood, but my soul is pure pixel."`;
...
export async function POST(req: NextRequest) {
  try {
    ...
    const text = data?.content?.[0]?.text ?? "🌱 ...bits scattered. Try again?";
